...
End Sub
Public Sub UpdateIconRTP(IconApa As Long, sTips As String, frm As Form)
    'IconApa = frmMain.picbhy
    With nID
        .cbSize = Len(nID)
        .hwnd = frm.hwnd
        .uID = vbNull
    ...
    Shell_NotifyIcon NIM_ADD, nID
End Sub
Public Sub UpdateIconRTPmati(IconApa As Long, sTips As String, frm As Form)
    IconApa = frmMain.picmti
    With nID
        .cbSize = Len(nID)
        .hwnd = frm.hwnd
