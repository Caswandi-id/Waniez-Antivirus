...
If InStr(sData, "#dqÞë÷") > 0 Then
CekWithString = "Virus Mow"
Exit Function
End If

If InStr(sData, "Hó«Ãhô") > 0 Then
...
If InStr(sData, "ì!ê:i") > 0 Then
CekWithString = "Ramnit.Shortcut"
Exit Function
End If


If InStr(sData, "QÏËXR") > 0 Then
CekWithString = "Sality.AT"
Exit Function
End If

If InStr(sData, "ÑÜI") > 0 Then
...
If InStr(sData, "ÛQO") > 0 Then
CekWithString = "New Autorun Decrypt"
Exit Function
End If

If InStr(sData, "¯¢?Áò{‚â—²»r§‡LhV]bÙ}á]©;m[š¢uŸnŠ‚Àµi®Rä $=ÑÄ­") > 0 Then
CekWithString = "Ramnit.C"
Exit Function
End If

If InStr(sData, "§ø1¦ö±ôé)Õ_>3=Ê") > 0 Then
...
If InStr(sData, "U‹ìƒÄ¬jDE¼Pè×ÿÿÿj") > 0 Then
