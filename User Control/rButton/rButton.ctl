...
Begin VB.UserControl rButton 
   ...
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   ToolboxBitmap   =   "rButton.ctx":0000
End
Attribute VB_Name = "rButton"
    ...
    With UserControl
        ...
        Select Case mButtonStyle
            ...
            Case Is = Vista
                ...
                End If
            Case Is = Glass
                mBorderColor = &H808080     'mBackColor
                mBorderColorHover = &H8000&    '&H80C0FF      'mBackColorHover
                mBorderColorPressed = &H8000&  '&H80C0FF     ' mBackColorPressed
                '............................................................
    ...
    With UserControl
        ...
        Select Case mButtonStyle
            ...
            Case Is = Vista    '>> RoundedRectangle >> Draw Vista Style.
                If MouseDown Then
                    .ForeColor = 112233 'BDR_VISTA2
                    RoundRect hdc, 1, 1, .ScaleWidth - 2, .ScaleHeight - 2, 14, 14
                Else
                    .ForeColor = 112233 'BDR_VISTA1
                    RoundRect hdc, 1, 1, .ScaleWidth - 2, .ScaleHeight - 2, 14, 14
