VERSION 5.00
Begin VB.UserControl rProgressBar 
   AutoRedraw      =   -1  'True
   ClientHeight    =   300
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   295
   ToolboxBitmap   =   "rProgressBar.ctx":0000
End
Attribute VB_Name = "rProgressBar"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
'--------------------------Rendrav antivirus Indonesia---------------------------
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    .WriteProperty "Text", U_Text, vbNullString
...
C(8) = RGB(223, 251, 223)
C(9) = RGB(223, 251, 223)
C(10) = &H8000&    ' RGB(108, 255, 108)
C(11) = &H8000&     'RGB(108, 255, 108)
'\
C(12) = &H8000&     'RGB(26, 228, 26)
C(13) = &H8000&    ' RGB(26, 228, 26)
