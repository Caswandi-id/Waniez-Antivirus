...
Private Sub pCreate()
    '---------------------------------------------------------------------------------------
    ' Date      : 9/10/05
    ' Purpose   : Create the ucProgressBar window.
    '---------------------------------------------------------------------------------------
    pDestroy
...
Private Sub pDestroy()
    '---------------------------------------------------------------------------------------
    ' Date      : 9/10/05
    ' Purpose   : Destroy the ucProgressBar window.
    '---------------------------------------------------------------------------------------
    If mhWnd Then
        DestroyWindow mhWnd
        mhWnd = ZeroL
...
Public Property Get Vertical() As Boolean
    '---------------------------------------------------------------------------------------
    ' Date      : 9/10/05
    ' Purpose   : Return whether the ucProgressBar is drawn vertically.
    '---------------------------------------------------------------------------------------
    Vertical = mbVertical
End Property
Public Property Let Vertical(ByVal bNew As Boolean)
    '---------------------------------------------------------------------------------------
    ' Date      : 9/10/05
    ' Purpose   : Set whether the ucProgressBar is drawn vertically.
    '---------------------------------------------------------------------------------------
    mbVertical = bNew
    pCreate
End Property
...
Public Property Get Smooth() As Boolean
    '---------------------------------------------------------------------------------------
    ' Date      : 9/10/05
    ' Purpose   : Return whether the ucProgressBar is drawn smoothly or in chunks.
    '---------------------------------------------------------------------------------------
    Smooth = mbSmooth
End Property
Public Property Let Smooth(ByVal bNew As Boolean)
    '---------------------------------------------------------------------------------------
    ' Date      : 9/10/05
    ' Purpose   : Set whether the ucProgressBar is drawn smoothly or in chunks.
    '             Comctl version 6 always draws ucProgressBars in chunks.
    '---------------------------------------------------------------------------------------
    mbSmooth = bNew
    pCreate
End Property
